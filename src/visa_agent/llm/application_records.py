...
RECORD_EXTRACTION_INSTRUCTIONS = (
    ...
    "exhaustive. Each has kind, state, source_excerpt and confidence. "
    "'I have no other UK contacts' or '只有前面提到的姐姐，没有其他亲属或联系人' means "
    "complete_declared for an existing list, NOT none_declared. Include the sentence's "
    "applicant subject and UK scope in the excerpt, not just the negative fragment. A single trip/contact, "
