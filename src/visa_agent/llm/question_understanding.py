...
QUESTION_UNDERSTANDING_INSTRUCTIONS = (
    ...
    "a specific medical-treatment plan or a different UK route's fee.\n"
    ...
    "simply to continue preparation as information questions. Return [] if those are the only content. "
