...
QUESTION_UNDERSTANDING_INSTRUCTIONS = (
    ...
    "route_orientation: which UK visa route fits the stated purpose or where to confirm a route, including a "
    "choice between Standard Visitor and Student.\n"
    "eligibility_overview: the general Standard Visitor eligibility framework, including a sender asking whether "
    "they appear to qualify; this topic never decides their eligibility or predicts approval.\n"
    "biometrics: the Standard Visitor visa application-centre appointment, fingerprints, photograph, identity "
    "check, appointment location or documents to take to that appointment.\n"
    "after_apply: what happens after a Standard Visitor application is submitted, including decision notification, "
    "tracking within published processing times, or how to change, correct, cancel or withdraw a submitted application.\n"
    ...
    "sponsor_support: what a personal sponsor statement should explain and evidence of the support, funds, relationship "
    "and, where applicable, the sponsor's lawful UK status.\n"
    ...
    "including an approval prediction, an individual legal conclusion beyond the general eligibility framework, "
    "a sufficiency verdict, permitted work, "
