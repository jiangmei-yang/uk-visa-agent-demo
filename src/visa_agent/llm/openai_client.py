...
EXTRACTION_INSTRUCTIONS = (
    ...
    "resumes preparation; never treat it as confirmation of a summary. Keep all independently "
    ...
    "where to obtain or how to prepare one named document; unsupported = a genuine visa/preparation question not fully "
    "answered by those narrowly defined topics (including personal eligibility, approval chances, "
    "other UK visa fees, allowed work, or a specific financial sufficiency verdict); off_topic = "
