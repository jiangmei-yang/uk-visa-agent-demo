...
CURRENT_REPORT = ROOT / "eval_output" / "financial_document_deepseek_2026-09-07-v21.json"
...
def test_current_provider_run_is_bound_to_complete_source_prompt_schema_and_pdf_set() -> None:
    ...
    run_entry = json.loads((ROOT / "eval_output" / "financial_document_current_2026-09-07-v21.json").read_text())
